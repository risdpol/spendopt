...
def main():
    ...
    data_path_databricks = "/Workspace/Users/aditya.majumder@polestarllp.com/Spend_Optimization/Shama/Inputs/Data_Optimisation.xlsx"
    # Load dataset
    df = pd.read_excel(
